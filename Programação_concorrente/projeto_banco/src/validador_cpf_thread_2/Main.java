package validador_cpf_thread_2;
...
public class Main {
    public static void main(String[] args) {
        ...
        String saidaTempo = "src/tempos_execucao/tempo_execucao_cod2.txt";
        ...
        List<File> arquivos1 = listaArquivos.subList(0, listaArquivos.size() / 2);
        List<File> arquivos2 = listaArquivos.subList(listaArquivos.size() / 2, listaArquivos.size());
